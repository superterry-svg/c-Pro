...
export const STRATEGIES: Strategy[] = [
  ...
  // --- Neutral + Theta ---
  {
    ...
    explanation: '這是最受歡迎的收租策略之一。當你認為股市會像死水一樣，長期在一個箱型區間整理時使用。你同時操作一個「牛市看跌價差」和一個「熊市看漲價差」。這構築了一個上有頂、下有底的防護網。最大好處是：風險是嚴格封頂的，你不需要擔心半夜睡不著覺。適合在波動率高時進場賺取時間價值。',
    example: {
  ...
  },
  {
    ...
    explanation: '這是鐵禿鷹的變形，更加激進。你預期股價會非常精確地停留在某個價格附近。它結合了賣出跨式（高獲利）和保護性期權（限制風險）。獲利潛力比鐵禿鷹高，但獲利區間也更窄。這是一種以有限風險博取較高權利金收益的策略。',
    example: {
